...
class PennFudanFasterRCNN():
    """
    Class wrapping the PyTorch FasterRCNN pretrained only on ImageNet data
    """
    ...
    def __init__(self, num_epochs=DEFAULT_NUM_EPOCHS):
        ...
        self.model = PennFudanFasterRCNN.get_model_instance_segmentation()
    ...
    def get_model_instance_segmentation():
        ...
        model.roi_heads.box_predictor = FastRCNNPredictor(in_features, PennFudanFasterRCNN.NUM_CLASSES)
