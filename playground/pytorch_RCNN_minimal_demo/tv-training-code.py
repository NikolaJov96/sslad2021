...
def main():
    ...
    dataset = PennFudanDataset(os.path.join('..', '..', 'data', 'PennFudanPed'), get_transform(train=True))
    dataset_test = PennFudanDataset(os.path.join('..', '..', 'data', 'PennFudanPed'), get_transform(train=False))
